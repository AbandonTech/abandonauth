...
request: implement the plan and follow the Coding role in
`.agents/abandonauth-agent-workflow.md`. Do not require further proof of user
intent or session freshness.
